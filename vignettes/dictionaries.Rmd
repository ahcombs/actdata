...
This package contains data from 38 different publicly available affect control theory dictionary data sets. Basic information on these dictionaries is shown in the table below. Detailed information on each dictionary, including references, is available at the end of this page.
...
Relevant publications/more information: [Affect Control Theory website](https://affectcontroltheory.org/canada-dictionary-2001-2003/). Raw data available through Interact Java applet. 
...
Relevant publications/more information: [MacKinnon and Luke 2002](https://www.jstor.org/stable/3341547), [Affect Control Theory website](https://affectcontroltheory.org/canada-1980-1986/). Raw data available through Interact Java applet. 
...
Relevant publications/more information: Raw data available through Interact Java applet. 
