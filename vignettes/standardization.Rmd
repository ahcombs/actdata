...
Dictionaries often contain 14-digit binary strings known as "institution codes" that contain information about what contexts terms apply to. See vignette("dictionaries") for more information on what these strings mean and how to use functions within this package that help demystify and filter by them. 
