...
get_dicts <- function(){
  ...
  for(i in 1:nrow(d_info)){
    ...
    thisdict <- dictionary(
      key = this$key,
      components = str_split(this$components, ", *")[[1]],
      types = str_split(this$types, ", *")[[1]],
      genders = str_split(this$genders, ", *")[[1]],
  ...
  #   dictionary(
  #       key = "china1999",
  #       components = c("identity", "behavior", "modifier", "setting"),
  ...
  #   dictionary(
  #       key = "household1994",
  #       components = c("identity", "behavior"),
  ...
  #   dictionary(
  #       key = "internet1998",
  #       components = c("identity", "behavior", "setting"),
  ...
  #   dictionary(
  #       key = "nireland1977",
  #       components = c("behavior", "identity"),
