...
get_dicts <- function(){
  ...
  dicts = c(
    ...
    new("dictionary",
        ...
        description = "A shortened version of usgeorgiaduke2015 for use with a prisoner's dilemma example. Included with the BayesACT code."),
    new("dictionary",
        key = "prisonersdilemmaCOV",
        components = c("behaviors"),
        filetype = ".csv",
        source = "http://bayesact.ca/",
        description = "A shortened version of usgeorgiaduke2015 with covariance information for use with a prisoner's dilemma example. Included with the BayesACT code."),
    new("dictionary",
        key = "texas1998",
    ...
    new("dictionary",
        key = "usgeorgiaduke2015",
        types = c("cov", "sd"),
        genders = c("av"),
        filetype = ".csv",
        source = "http://bayesact.ca/",
        description = "Mean, standard deviation, and covariance data calculated using a subset of the University of Georgia 2015 dataset (uga2015 in this package). Part of the BayesACT package."),
    new("dictionary",
        key = "usmturk2015",
        genders = c("av"),
        filetype = ".csv",
