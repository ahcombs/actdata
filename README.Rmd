...
dict_table <- actdata:::get_meta("dict") %>% 
  ...
  dplyr::select(key, context, year, stats, components, genders, information, notes) %>% 
...
names(dict_table) <- c("Dataset key", "Country or context", "Year", "Statistics available", "Components", "Genders", "More information", "Notes")
