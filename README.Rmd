...
* *Component* indicates what kind of terms are included in the dictionary dataset. Typically, studies provide dictionary datasets with more than one component, but not all studies provide all possible components. Components include: 
    * *identities*
        : Words that describe actors. Typically nouns (e.g. academic, woman, youngster)
    * *behaviors*
        : Actions that actors can perform. Typically verbs (e.g. wheedle, acclaim, work)
    * *mods*
        : Modifiers. Typically adjectives that can be applied to identities (e.g. active, witty, young)
    * *settings*
        : Places and situations (e.g. airplane, alley, worship_service)
