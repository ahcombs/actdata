...
dict_table <- actdata:::read_metadata("dict") %>% 
  ...
  dplyr::select(key, context, year, types, components, genders, description, notes, source)

names(dict_table) <- c("Dataset key", "Country or context", "Year", "Data types", "Components", "Genders", "Description", "Notes", "Source")
